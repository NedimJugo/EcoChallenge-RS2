...
namespace EcoChallenge.Services.Migrations
{
    ...
    [Migration("20250824112627_MoreDbChanges2")]
    partial class MoreDbChanges2
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EcoChallenge.Services.Database.Entities.BalanceSetting", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<decimal>("WholeBalance")
                        .HasColumnType("decimal(18,2)");
            ...
            modelBuilder.Entity("EcoChallenge.Services.Database.Entities.Donation", b =>
                {
                    ...
                    b.Property<string>("StripePaymentStatus")
                        .HasMaxLength(50)
                        .HasColumnType("nvarchar(50)")
                        .HasColumnName("stripe_payment_status");
            ...
            modelBuilder.Entity("EcoChallenge.Services.Database.Entities.PasswordReset", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EcoChallenge.Services.Database.Entities.Photo", b =>
                {
                    ...
                    b.Property<int?>("RequestParticipationId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("RequestParticipationId");
            ...
            modelBuilder.Entity("EcoChallenge.Services.Database.Entities.RequestParticipation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int?>("FinanceManagerId")
                        .HasColumnType("int")
                        .HasColumnName("finance_manager_id");
                    ...
                    b.Property<DateTime?>("FinanceProcessedAt")
                        .HasColumnType("datetime2")
                        .HasColumnName("finance_processed_at");
                    ...
                    b.ToTable("RequestParticipations");
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            RewardPoints = 0,
                            Status = 0,
                            SubmittedAt = new DateTime(2025, 8, 1, 14, 30, 0, 0, DateTimeKind.Utc),
                            UserId = 1
                        },
                        new
                        {
                            ...
                            ApprovedAt = new DateTime(2025, 8, 2, 10, 0, 0, 0, DateTimeKind.Utc),
                            FinanceStatus = 0,
                            RequestId = 4,
                            RewardMoney = 10.00m,
                            RewardPoints = 50,
                            Status = 1,
                            SubmittedAt = new DateTime(2025, 8, 1, 15, 0, 0, 0, DateTimeKind.Utc),
                            UserId = 2
                        });
                });
            ...
            modelBuilder.Entity("EcoChallenge.Services.Database.Entities.Photo", b =>
                {
                    ...
                    b.HasOne("EcoChallenge.Services.Database.Entities.RequestParticipation", null)
                        .WithMany("Photos")
                        .HasForeignKey("RequestParticipationId");
            ...
            modelBuilder.Entity("EcoChallenge.Services.Database.Entities.RequestParticipation", b =>
                {
                    b.HasOne("EcoChallenge.Services.Database.Entities.User", "FinanceManager")
                        .WithMany()
